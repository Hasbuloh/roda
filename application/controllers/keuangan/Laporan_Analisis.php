...
class Laporan_Analisis extends ZEN_Controller {
    ...
    public function index() {
        ...
        $this->data['subview'] = 'keuangan/laporan_analisis/index';
    ...
    public function masuk_barang() {
        ...
        $this->load->view('keuangan/laporan_analisis/table_index_masuk',$this->data);
    }
    ...
    public function keluar_barang() {
        ...
        $this->load->view('keuangan/laporan_analisis/table_index_keluar',$this->data);
    }
    ...
    public function stok_barang () {
        ...
        $this->load->view('keuangan/laporan_analisis/table_index_stok',$this->data);
//        print_r($this->data);
    }
    ...
    public function stok_barang_cetak () {
        ...
        $this->load->view('keuangan/laporan_excel/laporan_stok_barang',$this->data);
//        print_r($this->data);
    }
...
//        print_r($this->data);
        $this->data['subview'] = 'keuangan/laporan_analisis/index_detail_keluar';
        $this->load->view('_layoutMain',$this->data);
    }
    ...
    public function detail_masuk() {
        ...
        $this->data['subview'] = 'keuangan/laporan_analisis/index_detail_masuk';
        $this->load->view('_layoutMain',$this->data);
    }
    ...
    public function masuk_barang_cetak() {
        ...
        $this->load->view('keuangan/laporan_excel/laporan_masuk_bulanan.php',$this->data);
        // print_r($this->data);
    }
    ...
    public function keluar_barang_cetak() {
        ...
        $this->load->view('keuangan/laporan_excel/laporan_keluar_bulanan.php',$this->data);
        // print_r($this->data);
    }
    ...
    public function tidak_bermutasi() {
        ...
        $this->load->view('keuangan/laporan_analisis/table_index_tidakbermutasi',$this->data);
    }
    ...
    public function tidak_bermutasi_cetak() {
        ...
        $this->load->view('keuangan/laporan_excel/laporan_tidakbermutasi',$this->data);
    }
