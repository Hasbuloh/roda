...
class Laporan_Mutasi extends ZEN_Controller {
	...
	public function index()
	{
	    ...
	    $this->data['subview'] = 'keuangan/laporan_mutasi/index';
    ...
    if ($awal && $akhir != NULL) {
		...
		$this->load->view('keuangan/laporan_mutasi/table_index',$this->data);
	}
    ...
    public function table_index_cetak() {
        ...
        $this->data['items'] = $this->Laporan->table_index($where,$like)->result();
        $this->load->view('keuangan/laporan_excel/laporan_mutasi',$this->data);
    }
}
