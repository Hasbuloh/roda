...
class Laporan_Bulanan extends ZEN_Controller {
    ...
    public function index() {
        ...
        $this->data['subview'] = 'keuangan/laporan_bulanan/index';
    ...
    public function tableIndex() {
        ...
        $this->load->view('keuangan/laporan_bulanan/table_index',$this->data);
    }
    ...
    function tableIndex1() {
      ...
      $this->load->view('keuangan/laporan_bulanan/table_index_1',$this->data);
    }
    ...
    public function cetak_excel() {
      ...
      $this->load->view('keuangan/laporan_excel/laporan_keluar_bulanan',$this->data);
    }
    ...
    public function cetak_excel_1() {
      ...
      $this->load->view('keuangan/laporan_excel/laporan_masuk_bulanan',$this->data);
    }
}
