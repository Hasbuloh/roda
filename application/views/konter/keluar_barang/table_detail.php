...
function hapus(id) {
  $.ajax({
    url: '<?= base_url('konter/Keluar_Barang/hapus_detail')?>',
    dataType: 'JSON',
    type: 'POST',
    data: {'id': id},
...
function updateQTY(id) {
  ...
  $.ajax({
    url: '<?= base_url('konter/Keluar_Barang/update_detail')?>',
    dataType: 'JSON',
    type: 'POST',
    data: {'id': id, 'qty': qty},
    success: function(data) {
...
function Simpan(id) {
    $.ajax({
        url: '<?= base_url('konter/Keluar_Barang/update_status')?>',
        dataType: 'JSON',
        type: 'POST',
        data: {'id': id},
        success: function(data) {
...
function redirect() {
    window.location = '<?= base_url('konter/Keluar_Barang')?>';
}
