...
<div class="panel panel-default">
  <div class="panel-heading">
    <a href="javascript:void(0)" onclick="showModal()" class="btn btn-sm btn-default"><i class="fa fa-plus-circle fa-fw"></i> Tambah</a> | Data Retur Barang Masuk | <a href="javascript:void(0)" class="text text-success" onclick="reload_table()"><i class="fa fa-refresh fa-fw"></i> Refresh</a>
  </div>
  <div class="panel-body">
    <div class="row">
      <div class="col-md-12">
            <div id="table">
                <?php $this->load->view('gudang/retur_barang/table_index')?>
            </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  function saveData() {
    ...
    $.ajax({
      url: '<?= base_url('gudang/Retur_Barang/editHeader')?>',
      dataType: 'JSON',
      type: 'POST',
      data: formData,
  ...
  function generateNoRetur(idreture) {
    $.ajax({
      url: '<?= base_url('gudang/Retur_Barang/generate_nourut')?>',
      dataType: 'JSON',
      type: 'POST',
      data: {'kode': idreture},
      success: function(data) {
  ...
  function redirect() {
      ...
      window.location = '<?= base_url('gudang/Retur_Barang/detailRetur?id=')?>'+id;
  }
