...
var tableUrl = "<?= base_url('gudang/Laporan_Analisis/stok_barang')?>";
...
$('#jenis').on('change',function(){
    var jenis = $(this).val();
    if (jenis == 0) {
        tableUrl = "<?= base_url('gudang/Laporan_Analisis/stok_barang')?>";
        enable_input();
    }
    else if (jenis == 1) {
        tableUrl = "<?= base_url('gudang/Laporan_Analisis/keluar_barang')?>";
        enable_input();
    }else if (jenis == 2) {
        tableUrl = "<?= base_url('gudang/Laporan_Analisis/masuk_barang')?>";
        enable_input();
    }else{
