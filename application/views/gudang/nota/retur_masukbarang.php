...
<body>
  ...
  <!-- In your local server -->
    ...
    <table>
      ...
      <tr>
        <td>JL. RAYA SUKABUMI NO.81 DS.SUKAMAJU, KEC.CIANJUR, KAB.CIANJUR. TELP. 0263-270788</td>
      </tr>
    </table>
    </div>
    <div class="right">
      ...
      <table class="table-item">
        <thead>
          <tr>
            ...
            <th style="text-align:center" class="normal" width="150px">Nama Part</th>
            <th style="text-align:center" class="normal">No.Faktur</th>
            <th style="text-align:right" class="normal">HET</th>
            <th style="text-align:center" class="normal">Qty</th>
            <th style="text-align:center" class="normal">Disc1</th>
            <th style="text-align:center" class="normal">Disc2</th>
            <th>Netto</th>
        ...
        <tbody>
          <?php $no=1;$totalqty=array();$total=array();foreach ($items as $item): ?>
            <tr>
              ...
              <td algin="right"><?= $item['harga_beli']?></td>
              <td align="right"><?= $total[]=$item['harga'] * $item['qty'] ?></td>
