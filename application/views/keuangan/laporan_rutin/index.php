...
<script type="text/javascript">
	var tableUrl = "<?= base_url('keuangan/Laporan_Rutin/table_index_masuk') ?>";
	...
	$('#jenis').on('change',function(){
		...
		if (jenis == 1) {
			tableUrl = "<?= base_url('keuangan/Laporan_Rutin/table_index_masuk') ?>";
		}else{
			tableUrl = "<?= base_url('keuangan/Laporan_Rutin/table_index_keluar') ?>";
		}
